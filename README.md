...
1. Explain the difference between `Relational Databases` and `SQL`.
   ...
   Relational Databases is the software itself that manages everything related to the database.
   SQL is the language used to query the database.
   Relational database is the system used whereas SQL is the language used.

2. Why do tables need a `primary key`?

   They need primary keys to implement a relationship between two tables.
...
4) What do we need in order to have a _many to many_ relationship between two tables.
   ...
   We will need a third table when it comes to many to many relationships.
